 ...
 * objeto de la clase será una palabra o cadena de terminales y no terminales,
 * que usaremos en la clase Productions, para indicar cuál es la producción de
 * nuestro símbolo no terminal.
 *
 ...
 * pasan al programa dentro del archivo input.cfg, está esta clase, cada objeto
 * simula una producción, y este trabajará con sus
...
class Chain {
 public:
  ...
  /// predeterminado y el de copia, usaremos más el por defecto.
  Chain(void);
