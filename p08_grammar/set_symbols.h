 ...
 * de sus metodos. La clase SetSymbols contiene un std::set<Symbol> que será la
...
class SetSymbols {
 public:
  ...
  SetSymbols(const std::string& name, const std::set<Symbol>& set_symbols);
  ...
  std::set<Symbol> GetSetSymbols(void) const;
  ...
  bool IsItInSetSymbols(const Symbol& symbol) const;
 ...
 private:
  ...
  std::set<Symbol> set_symbols_; ///< Variable donde guardamos el conjunto.
};
#endif
