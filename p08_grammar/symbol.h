 ...
 * sus metodos. La clase Symbol contiene un std::string, cada objeto será
 * un elemento del alfabeto de nuestro objeto gramática, y cada objeto Symbol
 * será también un elemento de nuestro conjunto de Símbolos no terminales 
 * dentro de nuestra gramática.
 *
